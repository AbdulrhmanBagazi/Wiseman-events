...
import { View, Text, ScrollView, Animated, TouchableOpacity, I18nManager, Alert } from 'react-native'
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.about}>
          ...
          <View style={styles.aboutB}>
            <TouchableOpacity style={styles.aboutButton} onPress={() => LanguageChangeHandler('ar')}>
              <View
            ...
            <TouchableOpacity style={styles.aboutButton} onPress={() => LanguageChangeHandler('en')}>
              <View
                style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start', flexDirection: 'row' }}>
